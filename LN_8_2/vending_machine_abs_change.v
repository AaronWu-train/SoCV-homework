module vending_machine (
    ...
    // Abstraction 2: change calculation is unconstrained (over-approximation)
    input         free_success,
    input  [2:0]  free_use50,
    input  [2:0]  free_use10,
    input  [2:0]  free_use5,
    input  [2:0]  free_use1,
    ...
    // =========================================================
    // Combinational datapath (abstracted: free success / change coins)
    // =========================================================
    always @(*) begin
